...
-**Там уже будет папка `public_html`, просто `удалите ее`, откройте `скачанный архив`, - > папку `public_html` из архива нужно `заархивировать` - > залить в папку сайта - > распаковать**
